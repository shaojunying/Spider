...
def get_tournament_data(year: str = "2025") -> Dict:
    ...
    for _ in range(0, 1):
        curl_command = f"""
        curl 'https://www.fivb.org/Vis2009/XmlRequest.asmx?Request=%3CRequests%3E%3CRequest%20Type=%22GetVolleyTournamentList%22%20Fields=%22logos%20code%20City%20CountryCode%20StartDate%20EndDate%20EventLogos%20Gender%20Name%20OrganizerType%20Season%20ShortNameOrName%20Type%20WebSite%22%3E%3CFilter%20%20FirstDate=%22{year}-01-01%22%20Statuses=%221%202%203%204%205%22/%3E%3C/Request%3E%3C/Requests%3E' \
        ...
        for event in results:
            if isinstance(event, dict):
                flattened_event = {
                    ...
                    'ShortNameOrName': event.get('shortNameOrName', ''),
                    'Type': event.get('type', ''),
